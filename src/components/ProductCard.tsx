				...
				<Link href={`/san-pham/${product.slug}`} className="group block h-full">
					<div
						...
						<div className="relative aspect-square overflow-hidden bg-muted">
							...
							<div
									className="absolute top-3 right-3 opacity-90 group-hover:opacity-100 transition-all duration-500 z-20 group-hover:rotate-6 group-hover:scale-110">
							...
							<button
									...
									className="absolute bottom-4 right-4 px-4 py-3 bg-premium-red text-white rounded-xl shadow-[0_12px_24px_-12px_rgba(185,28,28,0.6)] opacity-0 translate-y-4 transition-all duration-500 group-hover:opacity-100 group-hover:translate-y-0 hover:bg-premium-red-light hover:scale-110 focus:outline-none focus:ring-2 focus:ring-premium-red/50"
